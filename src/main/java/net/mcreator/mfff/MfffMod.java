...
import net.mcreator.mfff.init.MfffModTabs;
import net.mcreator.mfff.init.MfffModMenus;
import net.mcreator.mfff.init.MfffModItems;
...
@Mod("mfff")
public class MfffMod {
	public static final Logger LOGGER = LogManager.getLogger(MfffMod.class);
	public static final String MODID = "mfff";

	public MfffMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		MfffModBlocks.REGISTRY.register(modEventBus);
		MfffModBlockEntities.REGISTRY.register(modEventBus);
		MfffModItems.register(modEventBus);

		MfffModTabs.REGISTRY.register(modEventBus);
		MfffModVariables.ATTACHMENT_TYPES.register(modEventBus);

		MfffModMenus.REGISTRY.register(modEventBus);
