...
public class ReturnCurrentUpkeepProcedure {
	public static String execute(LevelAccessor world, double x, double y, double z) {
		...
		return new java.text.DecimalFormat("##").format(upkeepCost * SffModVariables.MapVariables.get(world).force_projector_energy_cost) + "* 3 = "
				+ new java.text.DecimalFormat("##").format(upkeepCost * SffModVariables.MapVariables.get(world).force_projector_energy_cost * 3);
	}
}
